...
echo ""
echo ""
echo -e "\033[1mToday we are Talking about:\033[0m"
echo ""
echo ""
echo ""
echo "     => Why do we need Local Development Environments?"
read -p ""
echo "     => What Problems are we facing?"
read -p ""
echo "     => Live-Demo (Create/Deploy/Run operator locally)"
read -p ""
...
echo ""
echo ""
echo -e "\033[1mWhat is the Problem?\033[0m"
read -p ""
echo ""
echo ""
echo ""
...
echo ""
echo ""
echo -e "\033[1mWhy do we need Local Development Environments?\033[0m"
read -p ""
echo ""
echo ""
echo ""
...
read -p ""
echo "   🔒  Introduced convenient local SSL"
read -p ""
echo "   🚀  Speed improved"
read -p ""
echo "   💰  Costs reduced"
